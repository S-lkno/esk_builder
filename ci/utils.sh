...
*Features:* KSU $(parse_bool "$KSU"), SuSFS $(parse_bool "$SUSFS"), LXC $(parse_bool "$LXC"), Droidspaces $(parse_bool "$DROIDSPACES"), USB serial $(parse_bool "$USB_SERIAL"), USB net $(parse_bool "$USB_NET"), USB WLAN $(parse_bool "$USB_WLAN"), Stock config $(parse_bool "$STOCK_CONFIG")
EOF
    )
